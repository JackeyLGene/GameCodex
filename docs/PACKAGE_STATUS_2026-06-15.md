...
**Date:** 2026-06-15  
**Status:** repository entry prepared; manuscript package cleaned for internal pre-submission review.

## Current Entry

- Root entry: [`../README.md`](../README.md)
- Current manuscript: [`MANUSCRIPT_v8_PNAS.md`](MANUSCRIPT_v8_PNAS.md)
...
- Current manuscript exists as `MANUSCRIPT_v8_PNAS.md`.
- Manuscript status/footer now identifies V8.
...
- Root README now points to the current manuscript, results, figures, and reproduction notes.
