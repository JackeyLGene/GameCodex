...
**v5 fixes:** figure numbering realigned; references [3]/[4] corrected; Fig. 0
rank language fixed; Japan-only robustness narrowed to drift replication;
...
0.0146 and standard deviation 0.0098. The empirical 95% range is [0.000,
...
*Source trace:* `results/figures/fig0_paired_vignette_trace.csv`. Rhythm effect sizes quoted in §1.1 were computed by `divine_move.py` and `kejie_alphago.py`; per-move rank/winrate data are available in the trace file.
...
*Internal review version. v5. P0/review fixes applied. 2026-06-15.*
